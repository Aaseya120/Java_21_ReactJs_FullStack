...
export const ordersApi = {
  ...
  approveRefund: (id, data) => gatewayClient.post(`/api/v1/orders/${id}/refund/approve`, data),
  rejectRefund: (id, data) => gatewayClient.post(`/api/v1/orders/${id}/refund/reject`, data),
};
